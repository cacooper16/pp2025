...
export const GrowthCard = () => {
	return (
		<div className="flex h-[260px] relative items-center justify-center antialiased overflow-hidden">
			<img
				src="/img/services/growth.png"
				alt="Product Growth with ProductPartner"
				className="w-full h-full object-cover"
			/>
			<img
				src="/img/services/mark.svg"
				alt=""
				role="presentation"
