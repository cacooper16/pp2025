		...
		<>
			<div className="relative">
				<button
					...
					className="hidden md:block fixed bottom-6 right-6 bg-zinc-800 h-12 w-12 rounded-full text-white"
				>
							...
							>
								...
								<div className="col-span-1 border bg-white rounded-lg shadow-md overflow-hidden">
									<div className="py-8 px-8 md:px-12">
										...
										<p className="text-sm text-zinc-500 mb-4">
											Led and executed product strategy for a
											multisided platform (B2B, B2C, B2B2C), enhancing
											access to healthcare across multiple countries.
										</p>
										<p className="text-sm hover:text-blue-700 duration-300 transition-colors mb-2">
											<a
								...
								<div className="col-span-1 border bg-white rounded-lg shadow-md overflow-hidden">
									<div className="py-8 px-8 md:px-12">
										...
										<p className="text-sm text-zinc-500 mb-4">
											Designed and developed an engaging online
											presence for Ashworth Research, a leading market
											and social research consultancy for nonprofits.
										</p>
										<p className="text-sm hover:text-blue-700 duration-300 transition-colors mb-2">
											<a
								...
								<div className="col-span-1 border bg-white rounded-lg shadow-md overflow-hidden">
									<div className="py-8 px-8 md:px-12">
										...
										<p className="text-sm text-zinc-500 mb-4">
											Created a dynamic online presence for Café
											Bardin, a popular brunch spot in Alicante, to
											attract English-speaking customers and drive
											footfall.
										</p>
										<p className="text-sm hover:text-blue-700 duration-300 transition-colors mb-2">
											<a
								...
								<div className="col-span-1 border bg-white rounded-lg shadow-md overflow-hidden">
									<div className="py-8 px-8 md:px-12">
										...
										<p className="text-sm text-zinc-500 mb-4">
											Collaborating with a pre-launch startup:
											refining their business model, designing the
											product and selecting development partners.
										</p>
					...
					<div className="mb-16 lg:mb-32 grid grid-cols-1 gap-4 md:grid-cols-2 md:max-w-2xl md:mx-auto mx-8">
						...
						>
							<div className="col-span-1 border hover:border-zinc-600 md:rounded-tr-3xl rounded-lg shadow-sm overflow-hidden cursor-pointer group transform transition-transform duration-300  bg-white p-8 text-left">
								<h4 className="font-medium text-lg mb-2">
									<i className="bi bi-lightning-charge mr-1"></i> Chat
									Now
								</h4>
								<p className="text-sm text-zinc-500 mb-4">
						...
						>
							<div className="col-span-1 border hover:border-zinc-600 rounded-bl-3xl rounded-br-3xl rounded-t-lg md:rounded-br-3xl md:rounded-lg shadow-sm overflow-hidden cursor-pointer group transform transition-transform duration-300  bg-white p-8 text-left">
								<h4 className="font-medium text-lg mb-2">
